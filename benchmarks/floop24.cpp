...
// floop24 generated by makeloops.py Tue Jun 28 15:54:20 2011
  ...
  void ArrayVersion_index(BenchmarkExt<int>& bench)
{
    ...
    while (!bench.doneImplementationBenchmark())
    {
        ...
        for (long i=0; i < iters; ++i)
        {
            x = a(tensor::i)*c(tensor::i) - b(tensor::i)*c(tensor::i); y(tensor::i) = a(tensor::i)*d(tensor::i) + b(tensor::i)+c(tensor::i);
            sink();
        }
        bench.stop();
