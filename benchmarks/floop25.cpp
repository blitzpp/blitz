...
// floop25 generated by makeloops.py Tue Jun 28 15:54:20 2011
...
void ArrayVersion_unaligned(BenchmarkExt<int>& bench, float u, float v, float w);
void ArrayVersion_misaligned(BenchmarkExt<int>& bench, float u, float v, float w);
void ArrayVersion_index(BenchmarkExt<int>& bench, float u, float v, float w);
  ...
  void ArrayVersion_index(BenchmarkExt<int>& bench, float u, float v, float w)
{
    ...
    while (!bench.doneImplementationBenchmark())
    {
        ...
        for (long i=0; i < iters; ++i)
        {
            x = u*b(tensor::i); y(tensor::i) = v*b(tensor::i) + w*a(tensor::i) + u*c(tensor::i);
            sink();
        }
        bench.stop();
  ...
  void ArrayVersion_misaligned(BenchmarkExt<int>& bench, float u, float v, float w)
{
    ...
    Array<float,1> y(yfill(Range(4,N+4-1)));
    initializeRandomDouble(y.dataFirst(), N);
