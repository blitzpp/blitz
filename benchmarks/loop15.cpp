...
// loop15 generated by makeloops.py Tue Jun 28 15:54:20 2011
...
extern "C" {
  void loop15_f77(const int& N, double* x, double* a, double* b, double* c);
  void loop15_f77overhead(const int& N, double* x, double* a, double* b, double* c);
  void loop15_f90(const int& N, double* x, double* a, double* b, double* c);
  void loop15_f90overhead(const int& N, double* x, double* a, double* b, double* c);
...
void F77Version(BenchmarkExt<int>& bench)
{
    ...
    while (!bench.doneImplementationBenchmark())
    {
        ...
        for (int iter=0; iter < iters; ++iter)
            loop15_f77(N, x, a, b, c);
        bench.stop();

        bench.startOverhead();
        for (int iter=0; iter < iters; ++iter)
            loop15_f77overhead(N, x, a, b, c);
